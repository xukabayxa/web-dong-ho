<div class="single-product-area mt-30">
    <div class="product-thumb">
        ...
        <div class="action-links">
            <a href="javascript:void(0)" class="cart-btn" title="Đặt mua hàng" ng-click="addToCart({{$product->id}},1)"><i class="icon-basket-loaded"></i></a>
            {{-- <a href="wishlist.html" class="wishlist-btn" title="Add to Wish List">
                <i--}} {{-- class="icon-heart"></i>
            </a>--}}
            <a href="javascript:void(0)" class="quick-view" title="Quick View" ng-click="showModalDetail({{$product->id}})"><i class="icon-magnifier icons"></i></a>
        </div>
