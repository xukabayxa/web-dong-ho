...
@section('content')
    ...
    <div class="container" ng-controller="Cart">
        <div class="row">
            ...
            <div class="orderbox" ng-if="checkCart">
                <div class="navigate"><a href="{{route('homePage')}}" title="">Tiếp tục mua hàng</a><label>Giỏ hàng của
                        bạn</label></div>
                <div class="boxFormPayment">
                    <ul class="listcart all">
                        <li class="cartitem" ng-repeat="item in items">
                            <div class="oimg">
                                ...
                                <a href="" ng-click="removeItem(item.id)" title="Xóa" class="odel">Xóa</a>
                            </div>
                            <div class="oname">
                                <h3><a href=""
                    ...
                    <form name="cart_form" id="cart_form" class="form-list">
                        <div class="fpanel all">
                            <div class="title-user">Thông tin khách hàng</div>
                            <div class="form-group">
                                <label class="radioPure">
                                    <input id="radio1" type="radio" name="Gender" value="1"><span class="outer"><span
                                            class="inner"></span></span><i>Anh</i></label>
                                <label class="radioPure">
                                    <input id="radio2" type="radio" name="Gender" value="0"><span class="outer"><span
                                            class="inner"></span></span><i>Chị</i></label>
                            </div>
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <input type="text" class="form-control" name="Name" ng-model="form.customer_name"
                        ...
                        <strong><% errors.customer_name[0] %></strong>
                                ...
                                <div class="col-md-6 form-group">
                                    <input type="text" class="form-control" name="Phone"
                                           ng-model="form.customer_phone" placeholder="Số điện thoại">
                                    <span class="invalid-feedback d-block" role="alert">
                        <strong><% errors.customer_phone[0] %></strong>
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="Email" ng-model="form.customer_email"
                                       placeholder="Email">
                                <span class="invalid-feedback d-block" role="alert">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="Address" ng-model="form.customer_address"
                                       placeholder="Địa chỉ, Số nhà, Tòa nhà, Đường phố, Xã Phường, Quận Huyện...">
                                <span class="invalid-feedback d-block" role="alert">
                        <strong><% errors.customer_address[0] %></strong>
                     </span>
                            </div>
                            <div class="form-group">
                                <textarea class="form-control" name="Content" rows="5" ng-model="form.customer_required"
                            ...
                            <div class="form-group">
                                <label class="radioPure">
                                    <input id="payment_method_1" type="radio" name="payment_method"
                                           ng-model="form.payment_method" value="1" checked><span class="outer"><span
                                            class="inner"></span></span><i>Thanh toán khi nhận hàng - COD</i></label>
                                <label class="radioPure">
                                    <input id="payment_method_0" type="radio" name="payment_method"
                                           ng-model="form.payment_method" value="0"><span class="outer"><span
                                            class="inner"></span></span><i>Chuyển khoản qua ngân hàng</i></label>
                        ...
                        <strong><% errors.payment_method[0] %></strong>
                            ...
                            <div class="shockbuttonbox">
                                <a href="" id="btnOrder2" class="check-out" ng-click="submit()"><b>Thanh toán</b> <span>(Xem hàng, không mua không sao)</span>
                                </a>
                            </div>
                        </div>
                    </form>
            ...
            {{--            <p ng-if="!checkCart">Chưa có sản phẩm nào</p>--}}
